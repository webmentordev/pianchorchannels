            ...
            <div class="max-w-[900px] m-auto py-[100px] grid grid-cols-3 520px:grid-cols-1 border-b border-b-dark-b">
                ...
                <div class="p-6 w-full col-span-1">
                    ...
                    <ul class="flex flex-col">
                        <NuxtLink class="mb-3 font-semibold text-gray-100" to="/">Home</NuxtLink>
                        <NuxtLink class="mb-3 font-semibold text-gray-100" to="/about">About</NuxtLink>
                        <NuxtLink class="mb-3 font-semibold text-gray-100" to="/contact">Contact</NuxtLink>
                    </ul>
                </div>
            </div>
        </div>
        <p class="bg-dark text-white font-semibold text-lg py-6 text-center">Copyrights &copy; Reserved</p>
    </footer>
</template>