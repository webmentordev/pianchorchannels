...
@section('content')
    <section class="h-screen relative overflow-hidden">
        ...
        <header class="max-w-[1400px] h-full m-auto flex items-center relative z-20">
            <div class="px-4">
                <h1 class="text-8xl font-bold text-dark-text leading-[120px] mb-9 animate-moveright 875px:text-6xl 875px:leading-[90px] 490px:text-6xl 490px:leading-[70px]">We Specialise <br> in
                    All Acpects <br> Of Building.</h1>
    ...
    <section class="w-full bg-yellow bg-main">
    ...
    <section class="w-full">
        <div class="max-w-[1200px] m-auto px-4 py-[100px] grid grid-cols-3 940px:grid-cols-1">
            <div class="col-span-1">
                <div class="bg-[#F5F5F5] rounded-lg px-8 py-[80px]" data-aos="zoom-in" data-aos-duration="1000">
                    <img src="{{ asset('assets/products/product-1.png') }}" class="m-auto 940px:max-w-[600px]" alt="Anchor Channel Image">
                </div>
            </div>
        ...
        <div class="max-w-[1200px] m-auto px-4 py-[100px]">
            ...
            <img src="{{ asset('assets/products/about.png') }}" class="max-w-[600px] m-auto w-full" data-aos="fade-up" data-aos-duration="1000">
        </div>
    </section>
    <x-details />
@endsection
