<section class="w-full bg-gray-100">
    <div class="max-w-[970px] m-auto px-4 py-[100px]">
        ...
        <div x-data="{ open: false }" data-aos="fade-up" data-aos-duration="2000">
            ...
            <div x-show="open" class="p-6 bg-white rounded-lg shadow-md mb-3" x-transition x-cloak>
                ...
                <a class="w-full" href="{{ asset('assets/products/product-2.png') }}" target="_blank"><img src="{{ asset('assets/products/product-2.png') }}" class="m-auto max-w-[600px] w-full"></a>
            </div>
        </div>
        <div x-data="{ open: false }" data-aos="fade-up" data-aos-duration="2000">
            <div x-on:click="open = ! open" class="w-full rounded-lg p-4 mb-3 text-white bg-dark hover:bg-main transition-all cursor-pointer flex justify-between items-center">
            ...
            <div x-show="open" class="p-6 bg-white rounded-lg shadow-md mb-3" x-transition x-cloak>
                ...
                <a class="w-full" href="{{ asset('assets/products/product-3.png') }}" target="_blank"><img src="{{ asset('assets/products/product-3.png') }}" class="m-auto max-w-[600px]"></a>
            </div>
        </div>
        <div x-data="{ open: false }" data-aos="fade-up" data-aos-duration="2000">
            <div x-on:click="open = ! open" class="w-full rounded-lg p-4 mb-3 text-white bg-dark hover:bg-main transition-all cursor-pointer flex justify-between items-center">
            ...
            <div x-show="open" class="p-6 bg-white rounded-lg shadow-md mb-3 grid grid-cols-2 gap-6 670px:grid-cols-1" x-transition x-cloak>
                <div class="p-6">
                    <img src="{{ asset('assets/products/ad-1.png') }}" class="w-[80%] m-auto mb-3">
                    <p>Offers bracket flexibility in all directions</p>
                </div>
                <div class="p-6">
                    <img src="{{ asset('assets/products/ad-2.png') }}" class="w-[80%] m-auto mb-3">
                    <p>Can be installed in different base materials (Concrete, masonry, wood etc.)</p>
                </div>
                <div class="p-6">
                    <img src="{{ asset('assets/products/ad-3.png') }}" class="w-[80%] m-auto mb-3">
                    <p>No pre-planning is required at a very early stage. PI anchor channels can be installed at any desired location</p>
                </div>
                <div class="p-6">
                    <img src="{{ asset('assets/products/ad-4.png') }}" class="w-[80%] m-auto mb-3">
                ...
                <div class="p-6">
                    <img src="{{ asset('assets/products/ad-5.png') }}" class="w-[80%] m-auto mb-3">
                    <p>At any later stage, the attached fixings can be replaced and re-adjusted on the channel profile</p>
                </div>

                <div class="p-6">
                    <img src="{{ asset('assets/products/ad-6.png') }}" class="w-[80%] m-auto mb-3">
        ...
        <div x-data="{ open: false }" data-aos="fade-up" data-aos-duration="2000">
            ...
            <div x-show="open" class="p-6 bg-white rounded-lg shadow-md mb-3" x-transition x-cloak>
                ...
                <a class="w-full" href="{{ asset('assets/products/product-3.png') }}" target="_blank"><img src="{{ asset('assets/products/product-4.png') }}" class="w-full"></a>
            </div>
        </div>
        <div x-data="{ open: false }" data-aos="fade-up" data-aos-duration="2000">
            <div x-on:click="open = ! open" class="w-full rounded-lg p-4 mb-3 text-white bg-dark hover:bg-main transition-all cursor-pointer flex justify-between items-center">
            ...
            <div x-show="open" class="p-6 bg-white rounded-lg shadow-md mb-3" x-transition x-cloak>
                ...
                <a class="w-full" href="{{ asset('assets/products/product-3.png') }}" target="_blank"><img src="{{ asset('assets/products/product-5.png') }}" class="w-full"></a>
            </div>
        </div>
        <div x-data="{ open: false }" data-aos="fade-up" data-aos-duration="2000">
            <div x-on:click="open = ! open" class="w-full rounded-lg p-4 mb-3 text-white bg-dark hover:bg-main transition-all cursor-pointer flex justify-between items-center">
            ...
            <div x-show="open" class="p-6 bg-white rounded-lg shadow-md mb-3 relative overflow-hidden" x-transition x-cloak>
                ...
                <img src="{{ asset('assets/email.png') }}" class="absolute right-3 bottom-5 w-[60px] rotate-45">
            </div>
        </div>
    </div>
</section>